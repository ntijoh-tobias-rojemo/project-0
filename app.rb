...
class App < Sinatra::Base
    ...
    post '/create_student' do
        ...
        File.open(public"/img/#{params[:name]}.jpeg , wb") {|file| file.write(params[:image][:tempfile].read)} # Stort File är en klass som defineras inom ruby som används för att interagera med filsustemet, lilla variabel som definerad i programmet
    end
end